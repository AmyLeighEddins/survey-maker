...
router
  .route('/:id/questions')
  .get(templateQuestionsController.getTemplateQuestions);
...
router
  ...
  .post(
    ...
    validate,
    templateQuestionsController.createTemplateQuestions
  );
...
router
  .route('/:id/questions/:question_id')
  .delete(templateQuestionsController.deleteATemplateQuestion);
